...
```
**Answer: There are 5 manufacturers with equally high average rating scores (4 average): Amano; Benoit Nihant; Beschle (Felchlin); Durci; and The Smooth Chocolator** 
...
Countries_with_50_plus_reviews <- chocolate %>% 
  ...
  reframe(country_of_bean_origin, mean = mean(rating), total= n(), cocoa_percent) %>%
   filter(total >= 50) %>%
  arrange(desc(total))
print((Countries_with_50_plus_reviews))
```
